                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                ...
                                ?>
                                <form role="form" action="<?php echo base_url('index.php/surat/tambah_surat_keluar');?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control" id="exampleInputEmail1" name="penerima" placeholder="Penerima">
                                </div>
                                <div class="form-group">
