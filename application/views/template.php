...
<!DOCTYPE html>
<head>
<title>SuratQ-SMK elkom Malang</title>
...
<!--logo start-->
<div class="brand">
    <a href="<?php echo base_url();?>index.php/surat" class="logo">
         SuratQ
    </a>
    ...
    <ul  class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span class="username"></span><?php echo $this->session->userdata('nama'); ?></span>
                <b class="caret"></b>
            </a>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    <a href="<?php echo base_url();?>index.php/surat_user">
